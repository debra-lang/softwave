...
const CACHE = 'softwave-v189';
const ASSETS = ['./', './index.html', './styles.css', './app.js', './controller.js', './audio.js', './visuals.js', './focus.js', './lab.js', './field.js', './manifest.webmanifest', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './site.css'];
