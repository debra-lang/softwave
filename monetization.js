...
(function (global) {
  ...
  const ANALYTICS_EVENTS = ['pricing_viewed', 'premium_feature_opened', 'premium_prompt_shown', 'premium_prompt_dismissed', 'premium_preview_started', 'checkout_started', 'checkout_completed', 'trial_started', 'plan_selected', 'premium_activated', 'premium_cancelled', 'premium_expired', 'save_limit_reached', 'moment_used', 'journey_completed', 'tuning_on', 'tuning_off', 'ai_assistant_opened', 'ai_command_completed', 'ai_command_failed', 'ai_command_undone', 'ai_voice_used', 'voice_opened', 'voice_command_completed', 'voice_command_failed', 'voice_permission_denied', 'voice_unsupported', 'subscription_cancelled', 'subscription_reactivated', 'find_my_sound_completed', 'sound_profile_created', 'frequency_painting_used', 'environment_saved', 'sound_saved'];
