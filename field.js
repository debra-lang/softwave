...
(function (global) {
  ...
  const PERSONA = {
    ...
    glassrain: { geo: 'trails', depth: 0.65, speed: 0.55, scale: 0.5, texture: 0.4, density: 0.35, flow: 'down', softness: 0.9, energy: 0.35, warmth: 0.25, rings: 8, amp: 0.05, harm: [4, 6, 3], wave: 1.6, tint: [150, 170, 205], light: [70, 105, 160], words: 'Close • Soft • Sheltered' },
    lapping:   { geo: 'ribbons', depth: 0.7, speed: 0.5, scale: 0.45, texture: 0.3, density: 0.45, flow: 'horizontal', softness: 0.95, energy: 0.35, warmth: 0.3, rings: 7, amp: 0.09, harm: [2, 3, 2], wave: 1.1, squash: 0.8, tint: [125, 185, 180], light: [45, 125, 120], words: 'Small • Calm • Lapping' },
    crickets:  { geo: 'points', depth: 0.85, speed: 0.4, scale: 0.7, texture: 0.2, density: 0.2, flow: 'drift', softness: 0.95, energy: 0.3, warmth: 0.35, rings: 6, amp: 0.06, harm: [3, 2, 1], wave: 0.9, tint: [165, 195, 150], light: [85, 120, 70], words: 'Sparse • Alive • Gentle' },
    cicadas:   { geo: 'particles', depth: 0.5, speed: 0.9, scale: 0.3, texture: 0.8, density: 0.85, flow: 'drift', softness: 0.75, energy: 0.5, warmth: 0.5, rings: 9, amp: 0.05, harm: [6, 9, 4], wave: 2.2, tint: [205, 190, 140], light: [140, 120, 55], words: 'Fine • Shimmering • Layered' },
    summernight: { geo: 'motes', depth: 0.95, speed: 0.35, scale: 0.85, texture: 0.15, density: 0.18, flow: 'drift', softness: 1, energy: 0.25, warmth: 0.55, rings: 5, amp: 0.07, harm: [2, 3, 1], wave: 0.8, tint: [185, 165, 190], light: [115, 90, 130], words: 'Warm • Dark • Open' },
    leaves:    { geo: 'particles', depth: 0.55, speed: 0.7, scale: 0.4, texture: 0.6, density: 0.55, flow: 'drift', softness: 0.9, energy: 0.4, warmth: 0.4, rings: 7, amp: 0.08, harm: [3, 5, 2], wave: 1.4, tint: [145, 195, 135], light: [70, 125, 60], words: 'Leafy • Drifting • Fresh' },
