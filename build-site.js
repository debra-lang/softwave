...
function toolLinksFor(p) {
  const map = { 'tinnitus-sound-masking': [['/tinnitus-masking-sounds/', 'Try masking sounds']], 'how-tinnitus-sound-generators-work': [['/tinnitus-sound-generator/', 'Open the sound generator']], 'white-vs-pink-vs-brown-noise': [['/?sound=white', 'Play white noise'], ['/?sound=pink', 'Play pink noise'], ['/?sound=brown', 'Play brown noise']], 'find-a-comfortable-tinnitus-masking-sound': [['/?exp=discovery', 'Sound Discovery'], ['/#match', 'Find My Tinnitus Sound']], 'tinnitus-and-sleep': [['/#sleep', 'Try Sleep Mode']], 'tinnitus-frequency': [['/#frequency', 'Try the frequency generator']], 'tinnitus-frequency-matching': [['/#match', 'Find My Tinnitus Sound']], 'nature-sounds-vs-noise-for-tinnitus': [['/?sound=rain', 'Play rain'], ['/#mixer', 'Open the mixer']], 'how-loud-should-tinnitus-masking-be': [['/', 'Open the sound generator']], 'speakers-vs-headphones-for-tinnitus-sounds': [['/', 'Open Softwave']] };
